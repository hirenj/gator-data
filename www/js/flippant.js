...
function set_styles(back, front, position) {
  ...
  var offsetLeft = front.offsetLeft;
  var offsetTop = front.offsetTop;
  back.style['min-height'] = front.offsetHeight + "px"
  back.style.width = front.offsetWidth + "px"
  while (front.offsetParent) {
    front = front.offsetParent;
    offsetLeft += front.offsetLeft;
    offsetTop += front.offsetTop;
  }
  back.style.top = offsetTop + "px"
  back.style.left = offsetLeft + "px"
